...
nn(torch::Tensor points, torch::Tensor tree, torch::Tensor queries) {
    ...
    sdfoam::nn(dtype_to_scalar_type(points.scalar_type()),
                points.data_ptr(),
                tree.data_ptr(),
                queries.data_ptr(),
                num_points,
...
farthest_neighbor(torch::Tensor points_in,
    ...
    sdfoam::farthest_neighbor(dtype_to_scalar_type(points.scalar_type()),
                               points.data_ptr(),
...
void init_triangulation_bindings(py::module &module) {
    sdfoam::global_cuda_init();

    py::register_exception<sdfoam::TriangulationFailedError>(
