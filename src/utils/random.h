...
inline SDFOAM_HD uint32_t mix(uint32_t x) {
    x ^= x >> 17;
    x *= 0xed5ad4bb;
    x ^= x >> 11;
    x *= 0xac4c1b51;
...
inline SDFOAM_HD RNGState make_rng(uint32_t seed) {
...
inline SDFOAM_HD uint32_t randint(RNGState &rngstate) {
