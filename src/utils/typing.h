...
#ifdef __CUDACC__
#define SDFOAM_HD __host__ __device__
#else
#define SDFOAM_HD
#endif
...
inline SDFOAM_HD uint32_t log2(uint32_t x) {
...
inline SDFOAM_HD uint32_t pow2_round_up(uint32_t x) {
