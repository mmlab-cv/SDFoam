...
struct ViewerOptions {
    ...
    // NEW: NeuS toggle + params
    bool  use_sdfoam   = false;   // off by default
    float inv_s      = 20.0f;   // 1/beta
    float eps        = 1e-6f;   // numerical guard
    int   sdf_channel = -1;     // -1 => use last attribute channel
};
